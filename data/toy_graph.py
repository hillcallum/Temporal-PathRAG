...
class ToyGraphBuilder:
    ...
    def create_toy_data(self):
        ...
        nodes = [
            ...
            {'id': 'nobel_prize', 'entity_type': 'Award', 'name': 'Nobel Prize in Physics', 'description': 'Award given to Einstein in 1921'},
        ...
        edges = [
            {'source': 'albert_einstein', 'target': 'ulm', 'relation_type': 'BORN_IN', 'description': 'Einstein was born in Ulm'},
            {'source': 'albert_einstein', 'target': 'nobel_prize', 'relation_type': 'AWARDED', 'description': 'Einstein received the Nobel Prize'},
            {'source': 'nobel_prize', 'target': 'photoelectric_effect', 'relation_type': 'AWARDED_FOR', 'description': 'Einstein received the prize for explaining the photoelectric effect'},
            {'source': 'marie_curie', 'target': 'warsaw', 'relation_type': 'BORN_IN', 'description': 'Marie Curie was born in Waesaw'},
            {'source': 'marie_curie', 'target': 'nobel_prize', 'relation_type': 'AWARDED', 'description': 'Marie Curie also received a Nobel Prize'}
        ]
